...
public class TaskService {
    ...
    @Path("/all")
    public Response getAllTasksByUser(@HeaderParam("username") String username, @HeaderParam("password") String password, String user) {
        if (username == null || password == null)
            ...
            return Response.ok(taskBean.getAllTasksByUser(user)).build();
        } else
